        ...
        <div key={hItem._id}>
          <div className="bg-gradient-to-t from-purple-400 to-purple-700 rounded-b-lg">
            <div className=" py-8 md:flex md:flex-row  md:w-full flex flex-col-reverse mx-auto  md:py-28 ">
              <div
                className="md:ml-8 text-xl md:basis-1/2 text-white py-8 mt-6 md:py-28 text-center  space-y-4 md:space-y-0 md:text-5xl md:flex md:flex-col md:gap-y-8 md:font-bold shadow-black "
              >
