...
function Header({ navBarItem }: Props) {
  ...
  return (
    <main className="py-2 sticky top-0 bg-background z-10 flex justify-between shadow-md border-b-2 ">
          ...
          <div className="flex gap-4">
            ...
            <li>
              <Link href={"../category/products"} legacyBehavior passHref>
                <div className={navigationMenuTriggerStyle()}>All Products</div>
              </Link>
            </li>
          </div>
        </ul>
